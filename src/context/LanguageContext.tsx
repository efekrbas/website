...
export const translations: Record<string, Record<string, string>> = {
    tr: {
        ...
        penetrationTesting: 'Siber Güvenlik',
        ...
        chatbotHeader: 'Efek 🤖',
        chatbotGreeting: 'Selam! Ben Efek, Efe\'nin yapay zeka asistanıyım 🤖 Sana nasıl yardımcı olabilirim?',
        ...
        chatSuggestContact: 'Efe\'yle nasıl iletişim kurabilirim?',
    ...
    en: {
        ...
        penetrationTesting: 'Cyber Security',
